...
public class MBNBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<GlortBlockEntity>> GLORT_BLOCK_ENTITY = REGISTER.register("glort", () -> BlockEntityType.Builder.of(GlortBlockEntity::new, MBNBlocks.GLORT.get()).build(null));
